        ...
        <div className="grid grid-cols-2 gap-10 md:grid-cols-4">
          <div className="col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              <span className="text-xl font-extrabold text-white tracking-tight" style={{ fontFamily: "'Plus Jakarta Sans', system-ui" }}>
                sahayak
              </span>
            </div>
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              {['English', 'हिंदी', 'తెలుగు'].map((l) => (
                <span key={l} className="text-xs font-medium text-white/50 border border-white/10 bg-white/5 px-3 py-1 rounded-full">
                  {l}
                </span>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href={APP_URL} target="_blank" rel="noopener noreferrer" className="text-sm text-white/55 hover:text-white transition-colors">
                  Try Sahayak
                </a>
              </li>
              <li>
                <a href={`${APP_URL}/upload`} target="_blank" rel="noopener noreferrer" className="text-sm text-white/55 hover:text-white transition-colors">
                  Upload a document
                </a>
              </li>
              <li>
                <a href={`${APP_URL}/documents`} target="_blank" rel="noopener noreferrer" className="text-sm text-white/55 hover:text-white transition-colors">
                  My documents
                </a>
              </li>
            </ul>
