...
const STATUS_PILL: Record<DocumentStatus, { label: string; className: string }> = {
  done: { label: 'Explained', className: 'bg-[#EAF7EF] text-[#2E9B67]' },
  action: { label: 'Pending', className: 'bg-[#FFF3E3] text-[#B5760F]' },
  ...
  return (
    <div className="flex min-h-full flex-col">
      <div className="flex-1 space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-full border border-[#D9E2F0] bg-white py-3.5 pl-12 pr-12 text-base text-[#101828] placeholder:text-[#98A2B3] outline-none focus:border-[#102D63] focus:ring-2 focus:ring-[#EAF1FF]"
          />
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center rounded-[18px] border border-[#E8EDF5] bg-white p-8 text-center">
      ...
      <button
        ...
        className="mt-4 flex w-full items-center justify-center gap-2.5 rounded-[16px] bg-[#102D63] px-4 py-4 text-base font-bold text-white shadow-[0_4px_20px_rgba(16,40,99,0.22)] active:translate-y-px"
      >
